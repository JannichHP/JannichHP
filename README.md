...
<div class="info" align="center">
    <h3> Welcome, I’m Jannich 👋 </h3>

***Computer Scientist*** *gratuated from [Erhvervsakademi Dania](https://eadania.dk/) in Skive, Denmark*.



**Mobile & Web Developer** focused on turning operational needs into reliable software. I build tools that make it easier to **see, understand, and act** on real‑time events—and I care about solutions that can be **operated and maintained** in the real world.

---

## 🔭 Current project: *Vandrens*

A web application for **monitoring water treatment stations**.
...
---
[![](https://visitcount.itsvg.in/api?id=JannichHP&icon=0&color=0)](https://visitcount.itsvg.in)
